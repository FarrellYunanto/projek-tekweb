        ...
        <div class="content content center pt-2 pb-2 w-50 rounded-4">
            <div class="row text-center">
                ...
                <div class="col-12 pb-2">
                    <label for="" class="float-start" style="font-size: larger;">Room Code</label>
                    <input type="text" id="kodeRuang" class="form-control" placeholder="Kode Ruangan" require>
                </div>
                <div class="col-12 pb-2">
                    <label for="" class="float-start" style="font-size: larger;">Room Name</label>
                    <input type="text" id="namaRuang" class="form-control" placeholder="Nama Ruangan" require>
                </div>
                <div class="col-12 pb-3">
                    <label for="" class="float-start" style="font-size: larger;">Capacity</label>
                    <input type="text" id="kapasitasRuang" class="form-control" placeholder="Kapasitas Ruangan" required>
                </div>
                <div class="col-12 pb-3">
                    <label for="" class="float-start" style="font-size: larger;">Room Image</label>
